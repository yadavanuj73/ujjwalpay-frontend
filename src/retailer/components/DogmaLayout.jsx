...
const DogmaLayout = ({ children }) => {
    ...
    const navItems = [
        ...
        { id: 'payout_hub', label: 'Payout Hub', icon: Landmark, path: '/payout-hub' },
        ...
        <div className="min-h-screen bg-[#f5f5f5] font-sans">
            ...
            <div className="bg-[#1a1a2e] text-white px-4 py-2 flex items-center justify-between text-sm">
                <div className="flex items-center gap-4">
                    <span className="font-semibold">Welcome, {currentUser?.businessName || currentUser?.name || 'Retailer'}</span>
