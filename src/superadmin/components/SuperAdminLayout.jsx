                ...
                <div className="bg-blue-50 text-slate-700 h-9 flex items-center px-6 shrink-0 border-b border-blue-100">
                    <div className="flex items-center gap-6 w-full max-w-7xl mx-auto">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[9px] font-black text-amber-600 uppercase tracking-widest">Master Auth Lock</span>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Portal Expiry</span>
                        ...
                        <div className="flex-1 flex justify-end items-center gap-4">
                            ...
                            <span className="text-slate-400 text-[9px] font-black uppercase tracking-[0.2em] hidden sm:block">SuperAdmin Node v1.0</span>
                        </div>
                    </div>
                </div>
